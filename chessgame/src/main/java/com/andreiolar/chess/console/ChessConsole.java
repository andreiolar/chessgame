package com.andreiolar.chess.console;
...
/**
 * console gui. example game: e2-e3 a7-a6 e3-e4 f7-f6 d1-e2 f6-f5 e4-f5 a6-a5 e2-e7 a5-a4 e7-e8
 *
 */
public class ChessConsole implements IPlayerHandler {
	...
	/**
	 * Returns the name of the specified piece. The name is based on color and type.
	 * 
	 * The first letter represents the color: B=black, W=white, ?=unknown
	 * 
	 * The second letter represents the type: B=Bishop, K=King, N=Knight, P=Pawn, Q=Queen, R=Rook, ?=unknown
	 * 
	 * A two letter empty string is returned in case the specified piece is null
	 * 
	 * @param piece
	 *            a chess piece
	 * @return string representation of the piece or a two letter empty string if the specified piece is null
	 */
